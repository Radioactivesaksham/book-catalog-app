...
categoryItem1 = CategoryItem(user_id=1, name="Maus",
                             description="Maus is a graphic novel by American cartoonist Art Spiegelman, serialized from 1980 to 1991. It depicts Spiegelman interviewing his father about his experiences as a Polish Jew and Holocaust survivor.",
                             categories=category8)
session.add(categoryItem1)
session.commit()

categoryItem1 = CategoryItem(user_id=1, name="Encyclopedia Britannica",
                             description="The Encyclopedia Britannica, formerly published by Encyclopedia Britannica, Inc., is a general knowledge English-language encyclopaedia. It was written by about 100 full-time editors and more than 4,000 contributors.",
                             categories=category7)
session.add(categoryItem1)
session.commit()

categoryItem1 = CategoryItem(user_id=1, name="The Autobiography of Benjamin Franklin",
                             description="The Autobiography of Benjamin Franklin is the traditional name for the unfinished record of his own life written by Benjamin Franklin from 1771 to 1790; however, Franklin himself appears to have called the work his Memoirs.",
...
categoryItem1 = CategoryItem(user_id=1, name="Scooby-Doo Team-Up",
                             description="The Dynamic Duo Batman and Robin team up with Scooby-Doo and his mystery busting friends the Mystery Inc.!",
                             categories=category8)
session.add(categoryItem1)
session.commit()

categoryItem1 = CategoryItem(user_id=1, name="Fahrenheit 451",
                             description="Fahrenheit 451 is a dystopian novel by American writer Ray Bradbury, first published in 1953. It is regarded as one of his best works. The novel presents a future American society where books are outlawed and firemen burn any that are found",
